...
Route::get('get-form-builder-edit', [FormBuilderController::class, 'editData'])->name('formbuilder.getEdit');
...
Route::get('/thank-you', function () { return view('FormBuilder.thank'); })->name('thank');