    ...
    <form action="{{ route('front.search.jobs') }}" id='searchForm' method="get">
        <div class="d-flex align-items-center justify-content-between gap-3">
            ...
            <div class="d-flex align-items-center flex-grow-1">
                ...
                <input type="text" class="form-control fs-14 text-gray" name="keywords" id="search-keywords"
                       placeholder="@lang('web.web_home.job_title_keywords_company')" autocomplete="off">
            </div>

            <!-- Location Search -->
            <div class="d-flex align-items-center flex-grow-1">
                <i class="fa-solid fa-location-dot input-icon me-2"></i>
                <input type="text" class="form-control fs-14 text-gray" name="location" id="search-location"
                       placeholder="@lang('web.web_home.city_or_postcode')" autocomplete="off">
            </div>

            <!-- Function Dropdown -->
            <div class="d-flex align-items-center flex-grow-1">
                <i class="fa-solid fa-briefcase input-icon me-2"></i>
                <select name="function" id="search-function" class="form-select fs-14 text-gray">
                    <option value="">@lang('web.web_home.select_function')</option>
                    <option value="it">@lang('web.web_home.it')</option>
                    <option value="finance">@lang('web.web_home.finance')</option>
                    <option value="marketing">@lang('web.web_home.marketing')</option>
                    <option value="healthcare">@lang('web.web_home.healthcare')</option>
                    <option value="education">@lang('web.web_home.education')</option>
    ...
    <!-- end blog-section -->
        ...
        @if(count($plans) > 0)
            ...
            <p class="fs-16 text-gray">
                * Diffusion selon le pack&nbsp;<br>
                * Partage de vos offres d'emploi sur Facebook&nbsp;<br>
                * Posts sur le « fil d'actualité »&nbsp;<br>
                * Présence sur la newsletter hebdomadaire&nbsp;<br>
                * Multidiffusion de vos annonces sur les sites&nbsp;: Indeed, Google Job, Trovit, Jooble...
            </p>
        </section>
    </div>
                    </div>
