...
<li class="nav-item {{ Request::is('form-builder') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" href="{{ route('formbuilder.index') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa-question"></i></span>
        <span class="aside-menu-title">{{ __('Test') }}</span>
    </a>
</li>

<li class="nav-item {{ Request::is('form-builder') ? 'active' : '' }}">
    <a class="nav-link d-flex align-items-center py-3" href="{{ route('user.scores') }}">
        <span class="aside-menu-icon pe-3"><i class="fas fa-question"></i></span>
        <span class="aside-menu-title">{{ __('Score') }}</span>
    </a>
</li>
