        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 mb-5">
    {{ Form::label('evaluation', __('messages.candidate_profile.votre_evaluation_enreprise').':', ['class' => 'form-label']) }}
    <div class="form-check form-check-inline">
        @for ($i = 1; $i <= 5; $i++)
            <div class="form-check form-check-inline">
                {{ Form::radio('evaluation', $i, false, ['class' => 'form-check-input', 'id' => 'evaluation_'.$i]) }}
                {{ Form::label('evaluation_'.$i, $i, ['class' => 'form-check-label']) }}
            </div>
        @endfor
    </div>
</div>
