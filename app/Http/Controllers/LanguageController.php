...
{
    // Fetch languages where is_default = 1 and iso_code is either 'fr' or 'en'
    $defaultLanguages = Language::where('is_default', 1)
        ->whereIn('iso_code', ['fr', 'en'])  // Only French and English
        ->get();

    // Pass the $defaultLanguages variable to the view
    return view('front_web.layouts.header', compact('defaultLanguages'));
}
// In your LanguageController
public function getUserLanguages()
{
    return \App\Models\Language::where('is_default', 1)
